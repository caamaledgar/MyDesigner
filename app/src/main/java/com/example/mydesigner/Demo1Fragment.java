 ...
 * Use the {@link Demo1Fragment#newInstance} factory method to
...
public class Demo1Fragment extends Fragment {
     ...
     * @return A new instance of fragment Demo1Fragment.
     */
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button button = (Button) view.findViewById(R.id.btnSiguiente);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                   navController.navigate(R.id.demo2Fragment);
            }
        });
